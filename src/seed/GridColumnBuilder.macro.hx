...
private function createStyle(info:GridColumnInfo):Expr {
  ...
  return switch info.kind {
    ...
    case Xs: macro seed.style.Breakpoint.xs({ gridColumn: $expr });
    case Sm: macro seed.style.Breakpoint.sm({ gridColumn: $expr });
    case Md: macro seed.style.Breakpoint.md({ gridColumn: $expr });
    case Lg: macro seed.style.Breakpoint.lg({ gridColumn: $expr });
    case Xl: macro seed.style.Breakpoint.xl({ gridColumn: $expr });
  }
}
